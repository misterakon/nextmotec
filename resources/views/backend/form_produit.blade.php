        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-md-9 mb-4">
              <label for="libelle" class="form-label fw-bold">Nom du produit <span class="text-danger fw-bold">*</span></label>
          ...
          <div class="row">
            <div class="col mb-4">
              <label for="libelle" class="form-label fw-bold">Présentation <span class="text-danger fw-bold">*</span></label>
