  ...
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel3">Catégorie de produit</h5>
        <button
          type="button"
          class="btn-close"
      ...
      <form class="modal_form"  action="{{ route('parametre.save_categorie') }}" method="post" enctype="multipart/form-data">
