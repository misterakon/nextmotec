          ...
          <div class="card-body">
            <ul class="p-0 m-0">
              <li class="d-flex mb-6">
                <div class="me-4">
                  <img src="{{ asset('public/backend/assets/img/products/iphone.png') }}" alt="User" class="rounded" width="46" />
                </div>
                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                  <div class="me-2">
              ...
              <li class="d-flex mb-6">
                <div class="me-4">
                  <img
                    src="{{ asset('public/backend/assets/img/products/nike-air-jordan.png') }}"
                    alt="User"
                    class="rounded"
                    width="46" />
                </div>
              ...
              <li class="d-flex mb-6">
                <div class="me-4">
                  <img src="{{ asset('public/backend/assets/img/products/headphones.png') }}" alt="User" class="rounded" width="46" />
                </div>
                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                  <div class="me-2">
              ...
              <li class="d-flex mb-6">
                <div class="me-4">
                  <img
                    src="{{ asset('public/backend/assets/img/products/apple-watch.png') }}"
                    alt="User"
                    class="rounded"
                    width="46" />
                </div>
              ...
              <li class="d-flex mb-6">
                <div class="me-4">
                  <img
                    src="{{ asset('public/backend/assets/img/products/amazon-echo.png') }}"
                    alt="User"
                    class="rounded"
                    width="46" />
                </div>
              ...
              <li class="d-flex">
                <div class="me-4">
                  <img
                    src="{{ asset('public/backend/assets/img/products/play-station.png') }}"
                    alt="User"
                    class="rounded"
                    width="46" />
                </div>
